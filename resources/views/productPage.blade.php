                ...
                <main class="col-lg-6">
                    ...
                    <div class="card mt-4 p-3 border-0 rounded-0 bg-light">
                        ...
                        <div class="d-flex flex-column mt-4 gap-3">
                            ...
                            <p class="mt-2 text-secondary">
                                *Оплата за доставку, осуществляется согласно тарифов выбранной транспортной компании.
                            </p>
                        </div>
                    </div>
                    <div class="card mt-2 p-3 border-0 rounded-0 bg-light">
                        ...
                        <ol class="p-0" style="list-style-position: inside;">
                            ...
                            <li>Наложенным платежем, при получении заказа в транспортной компании.</li>
                            <li>Наличными на нашем складе.</li>
                        </ol>
                    </div>
                </main>
            </div>

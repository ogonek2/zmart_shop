            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('category.store') }}" method="POST" class="form-block">
                                @csrf
                                <div class="form-body">
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="active tab-pane" id="create">
                                    <form class="form-vertical" method="POST" action="{{ route('catalog.store') }}">
                                        @csrf
                                        <div class="form-body">
                                            <div class="form-group">
                                        ...
                                        <div class="modal fade" id="catalogModal{{ $item->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('catalog.update', $item->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-body">

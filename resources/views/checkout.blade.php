            ...
            <div class="col-md-7">
                ...
                <div class="container mt-4">
                    ...
                    <div id="manual-address-container" class="mt-3 d-none">
                        <label for="manual-address" class="form-label">Адреса відділення:</label>
                ...
                <div class="container mt-4">
                    ...
                    <form class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label for="input_lastname1" class="form-label">Прізвище <b class="text-danger">*</b></label>
                        ...
                        <div class="col-md-6">
                            <label for="input_phone1" class="form-label">Номер телефону <b class="text-danger">*</b></label>
                            <input type="text" class="form-control" id="input_phone1" placeholder="+38 (0__) ___ __ __" required>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="input_comment1" class="form-label">Додати коментар до замовлення</label>
                                <textarea class="form-control resize-none" name="" id="input_comment1 w-100"></textarea>
                            </div>
                        </div>
                    </form>
                </div>
